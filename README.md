...
1. Install [Python 3.11 or 3.12](https://www.python.org/downloads/) and ensure it's on PATH.
...
You can provide Facebook credentials via environment variables or a local file for auto-login:

- Environment variables:
  - `FACEBOOK_EMAIL`
  - `FACEBOOK_PASSWORD`

- File: place `sessions/facebook-credentials.json` with:
  ```json
  {
...
If no credentials are provided, use the dashboard’s Manual Login to create a session.
